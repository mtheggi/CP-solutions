...
int MST_Kruskal(int const nodes, vector<pair<int , pair<int ,int >>> & graph )  /// return the minimum Spanning Tree Cost
{
...
int main() {
    ...
    cout << "Weight of MST by Kruskal : "  << MST_Kruskal(nodes ,graph) << endl ;
